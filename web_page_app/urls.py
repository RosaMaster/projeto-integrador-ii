...
urlpatterns = [
    ...
    path('teste-update/<int:pk>/', views.teste_update, name='teste_update'),
    path('teste-delete/<int:pk>/', views.teste_delete, name='teste_delete'),
    #path('', views.login_view, name='login'),
    path('login/', views.login_view, name='login'),
    #path('home/', views.home_view, name='home'),
    path('home-archivum/', views.home_interno_view, name='home_interno'),
    ...
    path('politica-termos-archivum/', views.politica_termos_uso_interno_view, name='politica_termos_uso_interno'),
